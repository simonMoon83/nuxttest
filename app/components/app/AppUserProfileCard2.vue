    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <!-- 헤더 -->
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-blue-600 dark:to-blue-700 px-6 py-5 text-gray-800 dark:text-white relative overflow-hidden border-b border-gray-200 dark:border-blue-500">
              <!-- 배경 패턴 -->
              <div class="absolute inset-0 opacity-10">
                <div class="absolute -top-2 -right-2 w-20 h-20 bg-blue-500 dark:bg-white rounded-full opacity-20"></div>
                <div class="absolute -bottom-4 -left-4 w-16 h-16 bg-blue-300 dark:bg-white rounded-full opacity-10"></div>
              </div>
              
              <div class="flex items-center justify-between relative z-10">
                <div class="flex items-center space-x-3">
                  <div class="w-12 h-12 bg-blue-500 dark:bg-white dark:bg-opacity-20 rounded-full flex items-center justify-center flex-shrink-0 backdrop-blur-sm shadow-sm">
                    <i class="pi pi-user text-xl text-white dark:text-white" aria-hidden="true"></i>
                  </div>
                  <div class="min-w-0 flex-1">
                    <h3 id="profile-card-title" class="font-semibold text-lg leading-tight truncate mb-0.5 text-gray-800 dark:text-white">
                      {{ user?.full_name || user?.username || '사용자' }}
                    </h3>
                    <p class="text-gray-600 dark:text-blue-100 text-sm leading-tight truncate m-0">
